...
const CourseCard = ({ image, title, duration, path }) => {
    return (
        <div className="xl:h-[26rem] group m-1 sm:m-4 md:h-[22rem] h-[18rem] xl:w-[20rem] md:w-[18rem] w-[14rem] border-2 border-slate-300 rounded-lg overflow-hidden transition-all duration-300 ease-in-out">
            <img src={image} className=" group-hover:scale-110  xl:h-[14rem] md:h-[12rem] h-[10rem] w-full object-cover rounded-t-md transition-all duration-300 ease-in-out" />
            <div className="p-4">
