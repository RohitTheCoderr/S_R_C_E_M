...
function Ragging() {
  return (
    <>
      ...
      <div className="relative w-full h-80 bg-cover bg-center font-sans" style={{
        backgroundImage:
      ...
      >
        ...
        <div className="relative z-10 text-center text-white py-20 sm:py-28">
          <h1 className="text-3xl sm:text-5xl font-bold text-[#ebf4f6] ">  Ragging Committee</h1>
          <p className="text-lg sm:text-xl mt-4"> Shri Ram College of Engineering & Management</p>
        </div>
      </div>

      <div className='w-[95%] md:[90%] my-8 lg:w-[85%] m-auto font-sans'>
        <div className="">
          <p className="font-bold text-[#088395] text-center text-2xl sm:text-3xl mb-4">
            RAGGING COMMITTEE
          </p>
          <p className="font-normal text-gray-800 text-justify">
        ...
        <div className="mt-5 px-4 sm:px-8 lg:px-16">
          <p className="font-bold text-[#088395] text-xl sm:text-2xl mb-2">
