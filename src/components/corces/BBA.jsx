    ...
    return (
        <div className="px-4 py-2 md:py-4 md:px-8 lg:py-8 lg:px-16">
            ...
            <p className="text-zinc-600 text-sm md:text-base lg:text-lg my-4 text-justify">
                Welcome to the Bachelor of Business Administration (BBA) program at Shri Ram College of Engineering and Management,
                a premier institution dedicated to shaping the future leaders of the business world. Our BBA program is a rigorous
            ...
            <p className="text-zinc-600 text-sm md:text-base lg:text-lg my-4 text-justify">
                ...
                (BBA) program. This curriculum is meticulously designed to equip students with essential management techniques,
                effective communication skills, and proficient business decision-making abilities. The program provides an extensive
                overview of various business functions and their applications, incorporating diverse learning methodologies such as
                training sessions, case studies, projects, presentations, and industrial visits. Interaction with experienced
                academicians and industry professionals further enriches the learning experience. Additionally, students benefit from
                hands-on experience in state-of-the-art computer labs, emphasizing the integration of technology with education to
            ...
            <ul className="text-zinc-600">
                ...
                <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Dynamic Presentations:</span> Develop and enhance presentation skills through regular assignments and public speaking opportunities.</li>
            ...
            <p className="text-zinc-600 text-sm md:text-base lg:text-lg text-justify mb-5">
                ...
                in the curriculum guidelines. Failure to fulfill this requirement will affect your eligibility for graduation.
            </p>
        </div>
    );
};
