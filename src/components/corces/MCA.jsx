    ...
    return (
        <div className="px-4 py-2 md:py-4 md:px-8 lg:py-8 lg:px-16">
            ...
            <p className="text-zinc-600 text-sm md:text-base lg:text-lg my-4 text-justify">
                Welcome to the Master of Computer Applications (MCA) program at Shri Ram College of Engineering and Management, a premier institution dedicated to nurturing the next generation of tech leaders.
