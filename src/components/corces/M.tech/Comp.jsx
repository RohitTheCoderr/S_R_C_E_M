        ...
        <div>
            <div className="relative w-full h-96 bg-cover bg-center " style={{ backgroundImage: 'url(https://img.freepik.com/premium-photo/luxurious-new-building-with-curb-appeal_1127-4448.jpg?semt=ais_hybrid)' }}>
                ...
                <div className="relative z-10 text-center text-white py-22 sm:py-32">
                    <h1 className="text-3xl sm:text-5xl font-bold text-[#ebf4f6] font-mono">Master of Technology (M.Tech.) in Computer Science</h1>
                    <p className="text-lg sm:text-xl mt-4">Welcome to the Master of Technology (M.Tech.) in Computer Science program at Shri Ram College of Engineering & Management. </p>
                </div>
            </div>
            <div className="px-4 py-2 md:py-4 md:px-8 lg:py-8 lg:px-16">
                ...
                <ul className="text-zinc-600">
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Advanced Knowledge:</span> Provide an in-depth understanding of advanced computer science concepts and technologies.</li>
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Research and Development:</span> Foster skills in research and development, enabling students to contribute to technological advancements.</li>
                ...
                <ul className="text-zinc-600 list-disc mx-5">
                    ...
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Computer Networks:</span>Learn about network design, protocols, and security in modern computing environments.</li>
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Database Systems:</span> Explore advanced database management systems, including distributed databases and data warehousing.</li>
                ...
                <ul className="text-zinc-600 list-disc mx-5">
                    ...
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Cybersecurity:</span> Study methods and tools for protecting information systems from cyber threats.</li>
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Cloud Computing:</span> Understand the principles and practices of cloud architecture, services, and deployment models.</li>
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Big Data Analytics:</span> Learn about techniques for processing and analyzing large datasets to derive actionable insights.</li>
                </ul>

                <h1 className="text-[#088395] text-xl md:text-2xl my-4 font-medium font-mono">Research and Project Work:</h1>
                <ul className="text-zinc-600 list-disc mx-5">
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Dissertation:</span> Conduct original research on a topic of interest, contributing new knowledge to the field of computer science.</li>
                    <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Industry Projects:</span> Collaborate with industry partners on real-world projects to apply theoretical concepts in practical scenarios.</li>
            ...
            <ul className="text-zinc-600 list-disc mx-5">
                ...
                <p className="text-zinc-600 text-sm md:text-base lg:text-lg text-justify">Graduates of the M.Tech. in Computer Science program are well-prepared for a variety of career roles, including:</p>
                <ul className="text-zinc-600 list-disc mx-5">
                    <li className="text-sm md:text-base lg:text-lg my-1">Software Engineer</li>
                    <li className="text-sm md:text-base lg:text-lg my-1">Data Scientist</li>
                    <li className="text-sm md:text-base lg:text-lg my-1">Cybersecurity Analyst</li>
                    <li className="text-sm md:text-base lg:text-lg my-1">Cloud Solutions Architect</li>
                    <li className="text-sm md:text-base lg:text-lg my-1">Machine Learning Engineer</li>
                    <li className="text-sm md:text-base lg:text-lg my-1">Research Scientist</li>
                </ul>
