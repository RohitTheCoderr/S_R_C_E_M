    ...
    return (
        <div>
            ...
            <div className="px-4 py-2 md:py-4 md:px-8 lg:py-8 lg:px-16">
                ...
                <h1 className="text-[#088395] text-xl md:text-2xl font-medium font-mono">Duration:</h1> 2 Years Mode: Full-Time Degree Awarded:Master of Technology (M.Tech.) in Mechanical Engineering
