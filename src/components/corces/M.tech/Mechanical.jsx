        ...
        <div>
            <div className="relative w-full h-96 bg-cover bg-center " style={{ backgroundImage: 'url(https://img.freepik.com/premium-photo/luxurious-new-building-with-curb-appeal_1127-4448.jpg?semt=ais_hybrid)' }}>
                ...
                <div className="relative z-10 text-center text-white py-22 sm:py-32">
                    <h1 className="text-3xl sm:text-5xl font-bold text-[#ebf4f6] font-mono">Master of Technology (M.Tech.) in Mechanical Engineering</h1>
                    <p className="text-lg sm:text-xl mt-4">Welcome to the Master of Technology (M.Tech.) in Mechanical Engineering program at Shri Ram College of Engineering and Management</p>
                </div>
            </div>
            <div className="px-4 py-2 md:py-4 md:px-8 lg:py-8 lg:px-16">
                <h1 className="text-[#088395] text-xl md:text-2xl my-4 font-medium font-mono"> Program Overview</h1>
                <p className="text-zinc-600 text-sm md:text-base lg:text-lg text-justify">
                    Our M.Tech. program is designed to provide advanced knowledge and specialized skills in mechanical engineering, preparing graduates for leadership roles and innovative careers in the engineering industry.
                </p>
                ...
                <h1 className="text-[#088395] text-xl md:text-2xl my-4 font-medium font-mono">Duration:</h1> 2 Years Mode: Full-Time Degree Awarded:Master of Technology (M.Tech.) in Mechanical Engineering
