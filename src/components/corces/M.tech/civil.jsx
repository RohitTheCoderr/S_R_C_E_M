    ...
    return (
        <div>
            ...
            <div className="px-4 py-2 md:py-4 md:px-8 lg:py-8 lg:px-16">
                ...
                <p className="text-zinc-600 text-sm md:text-base lg:text-lg my-4 text-justify">
                    <span className="text-[#088395] text-xl md:text-2xl font-medium font-mono"> Duration:</span> 2 Years Mode: Full-Time Degree Awarded: Master of Technology (M.Tech.) in Civil Engineering
                </p>
            ...
            <ul className="text-zinc-600 list-disc mx-5">
                <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Advanced Structural Analysis:</span> Study the principles and techniques for analyzing complex structural systems.</li>
                <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Geotechnical Engineering:</span> Explore soil mechanics, foundation design, and ground improvement techniques.</li>
                <li className="text-sm md:text-base lg:text-lg my-1"><span className="font-bold">Hydraulics and Water Resources Engineering:</span> Learn about the design and management of hydraulic systems and water resources.</li>
