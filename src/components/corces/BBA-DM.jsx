        ...
        <div>
            ...
            <div className="px-4 py-2 md:py-4 md:px-8 lg:py-8 lg:px-16">
                <p className="text-zinc-600 text-sm md:text-base lg:text-lg my-4 text-justify">
                    This specialized three-year program is designed to equip students with
                ...
                <p className="text-zinc-600 text-sm md:text-base lg:text-lg my-4 text-justify">
                    ...
                    program divided into six semesters, designed to equip students with in-depth knowledge of marketing strategies
                    and digital tools essential in today’s business world. The course curriculum covers subjects like Social Media
                    Marketing, Search Engine Optimization (SEO), Content Marketing, Pay-Per-Click Advertising (PPC), Web Analytics,
                    Email Marketing, E-Commerce Management, Consumer Behavior, Marketing Analytics, and Brand Management. Students
                    also gain hands-on experience in tools such as Google Analytics, AdWords, and various Content Management Systems
                    (CMS).With the exponential growth of the digital economy, businesses are increasingly relying on digital
                    platforms for their operations and marketing efforts. The demand for skilled digital marketers is skyrocketing,
                    making this course one of the most sought-after in the industry. Upon completing the BBA in Digital Marketing,
                    students can pursue advanced studies like MBA in Digital Marketing or step into roles such as Digital Marketing
                    Manager, SEO Specialist, Social Media Strategist, Content Creator, and E-Commerce Specialist. The course also
                ...
                <ul className="text-zinc-600">
                    <li className="text-sm md:text-base lg:text-lg my-1">
                        ...
                        Acquire a deep understanding of digital marketing concepts, including SEO, SEM, content marketing, social media strategy, and data analytics.
                    </li>
                    <li className="text-sm md:text-base lg:text-lg my-1">
                        <span className="font-bold">Strategic Techniques:</span>
                        Learn to develop and implement effective digital marketing campaigns that drive brand growth and customer engagement.
                    </li>
                    <li className="text-sm md:text-base lg:text-lg my-1">
                        <span className="font-bold">Hands-On Experience:</span>
                        Participate in live projects, case studies, and practical exercises to apply digital marketing strategies in real-world scenarios.
                    </li>
                    <li className="text-sm md:text-base lg:text-lg my-1">
                        <span className="font-bold">Technological Proficiency:</span>
                        Gain proficiency in essential digital marketing tools and platforms through dedicated training sessions in advanced computer labs.
                    </li>
                    <li className="text-sm md:text-base lg:text-lg my-1">
                ...
                <h1 className="text-[#088395] text-xl md:text-2xl font-medium my-4 font-mono">Program Benefits</h1>
                <ul className="text-zinc-600">
                    <li className="text-sm md:text-base lg:text-lg my-1">
                        <span className="font-bold">Industry-Relevant Skills:</span>
                        Develop expertise in the most current digital marketing techniques and tools, ensuring you are prepared for the competitive job market.
                    </li>
                    <li className="text-sm md:text-base lg:text-lg my-1">
                        <span className="font-bold">Practical Learning:</span>
                        Engage in experiential learning through projects and internships that provide practical experience and build a strong professional portfolio.
                    </li>
                    <li className="text-sm md:text-base lg:text-lg my-1">
                        <span className="font-bold">Personalized Development:</span>
                ...
                <h1 className="text-[#088395] text-xl md:text-2xl font-medium my-4 font-mono">Why Choose Digital Marketing?</h1>
