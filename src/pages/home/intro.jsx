  ...
  return (
    <div>
      <div className="h-[36rem] relative bg-gray-600">
        ...
        <div className="bg-white lg:h-16 md:h-13 h-10 lg:w-[30rem] md:w-[24rem] w-[16rem] z-30 relative m-auto -top-[59rem] rounded-xl flex text-center ">
          <h3 className="m-auto text-center lg:text-[1.5rem] md:text-[1.2rem] text-[0.9rem] font-semibold font-mono left-6 flex">
