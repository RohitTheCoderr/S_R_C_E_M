...
const Banner = ()=>{
    return(
        <div className="relative mt-[-4rem] z-50">
            <div className=" lg:px-24 md:px-12 px-6 rounded-2xl flex flex-wrap lg:mx-16 md:mx-8 mx-4 justify-evenly  ">
                <div className="bg-[#37B7C3] h-64 w-64 rounded-3xl lg:p-3 md:p-2 p-1 shadow-md shadow-black">
