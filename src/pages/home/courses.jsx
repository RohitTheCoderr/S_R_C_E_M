        ...
        <div>
            <div className="px-4 py-2 md:py-4 md:px-8 lg:py-10 lg:px-40 flex flex-wrap items-center justify-center">
                ...
                <div className="flex flex-wrap justify-around xl:gap-y-12 lg:gap-y-8 md:gap-y-6 gap-y-4 xl:mt-12 lg:mt-6 md:mt-4 mt-4">
                    <div className="xl:h-[24rem] lg:h-[16rem] md:h-[16rem] h-[16rem] xl:w-[22rem] lg:w-[14rem] md:w-[14rem] w-[14rem] hover:shadow-md shadow-slate-700 border-2 border-slate-300 rounded-sm hover:scale-105 transition-transform duration-300 ">
