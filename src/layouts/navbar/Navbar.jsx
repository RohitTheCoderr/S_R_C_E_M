      ...
      >
        ...
        <li className="relative group/parent cursor-pointer ">
          ...
          <ul className="absolute z-20 left-0 text-[#071952] text-start top-full hidden group-hover/parent:block group-hover/parent:border-t-[0.19rem] border-t-[#071952] text-[10px] sm:text-[11px] md:text-[12px] lg:text-sm bg-[#ebf4f6] shadow-lg w-[120px] sm:w-[120px] md:w-[160px] lg:w-[200px]">
            ...
            <li className="px-1 sm:px-2 lg:px-4 py-1 lg:py-2 relative group hover:bg-[#37b7c3]">
              ...
              <ul className="absolute left-full top-0 hidden group-hover:block group-hover:border-t-[0.19rem] border-t-[#071952] text-[10px] sm:text-[11px] md:text-[12px] lg:text-sm bg-[#ebf4f6] shadow-lg w-[120px] sm:w-[120px] md:w-[160px] lg:w-[200px]">
                <Link to={'/Mmechanical'}><li className="px-1 sm:px-2 lg:px-4 py-1 lg:py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">mechanical engineering</li></Link>
                <Link to={'/Mcomp'}><li className="px-1 sm:px-2 lg:px-4 py-1 lg:py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">computer science & engineering</li></Link>
                <Link to={'/Melectronics'}><li className="px-1 sm:px-2 lg:px-4 py-1 lg:py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">Electronics & commonication engineering</li></Link>
        ...
        <ul className="absolute left-0 text-[#071952] text-start top-full hidden group-hover/parent:block text-sm  bg-[#ebf4f6] shadow-lg w-[200px]">
          <li className="px-4 py-2 relative group hover:bg-[#37b7c3]">
            ...
            <ul className="absolute left-full top-0 hidden group-hover:block group-hover:border-t-[0.19rem] border-t-[#071952] text-sm bg-[#ebf4f6] shadow-lg w-[200px]">
              <Link to={'/Mechanical'}><li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
                mechanical engineering
              </li></Link>
              <Link to={'/Comp'}><li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
                computer science & engineering
              </li></Link>
              <Link to={'/Electronics'}> <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
                Electronics & commonication engineering
              </li></Link>
              <Link to={'/CivilEngg'}><li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
                civil engineering
              </li></Link>
            </ul>
          </li>
          ...
          <li className="px-4 py-2 relative group hover:bg-[#37b7c3]">
            ...
            <ul className="absolute left-full top-0 hidden group-hover:block group-hover:border-t-[0.19rem] border-t-[#071952] text-sm bg-[#ebf4f6] shadow-lg w-[200px]">
              <Link to={"/PCivil"}><li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
                civil polytechnic diploma
              </li></Link>
              <Link to={"/PCse"}><li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
                CSE polytechnic diploma
              </li></Link>
              <Link to={'/PDmlt'}><li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
                DMLT polytechnic diploma
              </li></Link>
              <Link to={'/PEce'}><li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
                ECE polytechnic diploma
              </li></Link>
              <Link to={'/PMechanical'}><li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">
