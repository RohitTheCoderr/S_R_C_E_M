    ...
    <div className="w-[60%]  h-auto">
      <ul className="capitalize flex justify-center items-center h-[4rem] space-x-6 text-[17px] font-medium">
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ...
              : " hover:border-b-[0.19rem] hover:text-[#088395] hover:border-[#37b7c3] transition-all duration-300"
          }
        >
        ...
        <li className="relative group/parent  cursor-pointer">
          ...
          {/* Main Dropdown */}
          <ul className="absolute left-0 text-[#071952] text-start top-full hidden group-hover/parent:block group-hover/parent:border-t-[0.19rem] border-t-[#071952] bg-[#ebf4f6] shadow-lg w-[200px]">
            ...
            <li className="px-4 py-2 relative group hover:bg-[#37b7c3]">
              ...
              <ul className="absolute left-full top-0 hidden group-hover:block group-hover:border-t-[0.19rem] border-t-[#071952]  bg-[#ebf4f6] shadow-lg w-[200px]">
        ...
        <li className="relative group/parent cursor-pointer">
          ...
          {/* Main Dropdown */}
          <ul className="absolute left-0 text-[#071952] text-start top-full hidden group-hover/parent:block bg-[#ebf4f6] shadow-lg w-[200px]">
            ...
            <li className="px-4 py-2 relative group hover:bg-[#37b7c3]">
              ...
              {/* Nested Dropdown for Co-Founder Principal */}
              <ul className="absolute left-full top-0 hidden group-hover:block group-hover:border-t-[0.19rem] border-t-[#071952] bg-[#ebf4f6] shadow-lg w-[200px]">
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">mechanical engineering</li>
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">computer science & engineering</li>
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">Electronics & commonication engineering</li>
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">civil engineering</li>
              </ul>
            </li>
            <li className="px-4 py-2 relative group hover:bg-[#37b7c3]">
              <div className="flex items-center">
            ...
            <li className="px-4 py-2 relative group hover:bg-[#37b7c3]">
              ...
              {/* Nested Dropdown for Infrastructure */}
              <ul className="absolute left-full top-0 hidden group-hover:block group-hover:border-t-[0.19rem] border-t-[#071952] bg-[#ebf4f6] shadow-lg w-[200px]">
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">civil polytechnic diploma</li>
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">CSE polytechnic diploma</li>
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">DMLT polytechnic diploma</li>
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">ECE polytechnic diploma</li>
                <li className="px-4 py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6]">Mechinical polytechnic diploma</li>
              </ul>
            </li>
        ...
        <li className="relative group cursor-pointer">
          ...
          <ul className="absolute left-0 text-[#071952] text-start top-full hidden group-hover:block group-hover:border-t-[0.19rem] border-t-[#071952] bg-[#ebf4f6] shadow-lg w-[200px] ">
