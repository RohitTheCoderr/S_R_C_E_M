...
// const Navbar = () => {
//  return (
//  <div className="w-[85%] md:w-[80%] lg:w-[85%] h-auto z-50">
//  <ul className="capitalize flex sm:justify-between md:justify-around lg:justify-center items-center h-[4rem] md:gap-3 lg:gap-5 text-[10px] sm:text-[11px] md:text-[12px] lg:text-[17px] font-medium">
//  {/* Home */}
//  <NavLink
//  to="/"
//  className={({ isActive }) =>
...
//  {/* Main Dropdown */}
//  <ul className="absolute left-0 text-[#071952] text-start top-full hidden group-hover/parent:block group-hover/parent:border-t-[0.19rem] border-t-[#071952] text-[10px] sm:text-[11px] md:text-[12px] lg:text-sm bg-[#ebf4f6] shadow-lg w-[120px] sm:w-[120px] md:w-[160px] lg:w-[200px]">
...
//  <RiArrowDropDownLine className="text-[24px]" />
//  </div>
//  <ul className="absolute left-0 text-[#071952] text-start top-full hidden group-hover:block group-hover:border-t-[0.19rem] text-sm border-t-[#071952] text-[10px] sm:text-[11px] md:text-[12px] lg:text-sm bg-[#ebf4f6] shadow-lg w-[120px] sm:w-[120px] md:w-[160px] lg:w-[200px]">
//  <li className="px-1 sm:px-2 lg:px-4 py-1 lg:py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6] ">Agrements</li>
//  <li className="px-1 sm:px-2 lg:px-4 py-1 lg:py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6] ">Corporate Tie UPS</li>
//  <li className="px-1 sm:px-2 lg:px-4 py-1 lg:py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6] ">MOU</li>
//  <li className="px-1 sm:px-2 lg:px-4 py-1 lg:py-2 hover:bg-[#37b7c3] hover:text-[#ebf4f6] ">Job-Fair 2024</li>
